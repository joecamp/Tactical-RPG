...
public class CameraMouseInteractions : MonoBehaviour {
	...
	/// <summary>
	/// Using Raycast from CheckMouseHover,
	...
	/// <summary>
	/// Completes and stores a RaycastHit, handles hovering over IInteractable objects
	/// </summary>
	protected void CheckMouseHover () {
		if (EventSystem.current.IsPointerOverGameObject ()) {
			raycastOverObject = false;
			return;
		}
