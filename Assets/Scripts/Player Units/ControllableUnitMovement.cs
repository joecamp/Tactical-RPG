...
#pragma warning restore 414
	...
	private void Update () {
		...
		if (controllableUnit.state == ControllableUnit.UnitStateEnum.Idle) {
			Move (Vector3.zero);
			agent.updatePosition = false;
		}
		else if (controllableUnit.state == ControllableUnit.UnitStateEnum.MovingToDestination) {
	...
	public void SetDestination (Vector3 target) {
		...
		if (controllableUnit.state != ControllableUnit.UnitStateEnum.Paused) {
	...
	private void OnDrawGizmos () {
		// draw the path in editor for debugging
